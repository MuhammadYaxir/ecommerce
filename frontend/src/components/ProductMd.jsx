...
const ProductMd = (props) => {
  ...
  return (
    <section className="mx-auto max-w-[1440px] px-6 lg:px-12 flex flex-col gap-8 xl:flex-row bg-primary py-4">
      {/* Left Side */}
      ...
      <div className="flex flex-col xl:flex-[1.5] bg-white px-6 py-2 rounded-xl">
        ...
        <div className="flex items-baseline gap-x-6 bold-24 sm:bold-28 mt-3">
          ...
          <div className="flex items-start gap-x-1 text-[16px] font-[500] text-secondary">
            <FaStar />
            <FaStar />
            <FaStar />
            <FaStar />
        ...
        <div className="flex flex-col sm:flex-row gap-x-10 gap-y-3 my-4">
          <div>
            ...
            <div className="flex gap-3 my-3">
              <div className="h-10 w-10 flex items-center justify-center cursor-pointer rounded-sm bg-secondaryRed border-b-black active-color"></div>
              <div className="h-10 w-10 flex items-center justify-center cursor-pointer rounded-sm bg-secondaryYellow "></div>
              <div className="h-10 w-10 flex items-center justify-center cursor-pointer rounded-sm bg-secondaryBlue "></div>
              <div className="h-10 w-10 flex items-center justify-center cursor-pointer rounded-sm bg-secondaryGreen"></div>
            </div>
          </div>
          <div>
            <h4 className="bold-16">Select Size:</h4>
            <div className="flex gap-3 my-3">
              <div className="h-10 w-10 flex items-center justify-center cursor-pointer rounded-sm  border-[1.5px] border-slate-900/15">
                S
              </div>
              <div className="h-10 w-10 flex items-center justify-center cursor-pointer rounded-sm  border-[1.5px] border-slate-900/15">
                M
        ...
        <div className="flex gap-4 mb-8 max-w-[555px] flex-wrap">
            ...
            className="btn-dark rounded-sm sm:!px-20 !py-2 flex items-center justify-center gap-x-2">Go to cart
            ...
            {!cartItems[product._id] ? (
                ...
                <div className="bg-tertiary text-white rounded-sm flex items-center justify-center gap-2">
                    <FaMinus
        ...
        <p>
            <span className="text-[16px] font-[500] text-tertiary">Category : </span>
            Women | Jacket | Winter
        </p>
        <p>
            <span className="text-[16px] font-[500] text-tertiary">Tags : </span>
            Modern | new | Arrivals
        </p>
